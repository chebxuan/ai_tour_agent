    ...
    return [
        {
            ...
            "question": "您计划游览北京几天？",
            "options": [
                {"text": "2天", "weight": {"city": "北京", "days": 2}},
                {"text": "3天", "weight": {"city": "北京", "days": 3}},
                {"text": "4天", "weight": {"city": "北京", "days": 4}}
            ]
        },
        {
            "step": 2,
        ...
        },
        {
            ...
            "question": "是否需要英文导游？",
            "options": [
                {"text": "需要全程英文导游", "weight": {"guide": "BJ-GUIDE-01"}},
        ...
        },
        {
            ...
            "question": "酒店档次偏好？",
            "options": [
                {"text": "经济型（全季-亚运村）", "weight": {"hotel": "BJ-HOTEL-01"}},
                {"text": "舒适型（全季-前门四合院）", "weight": {"hotel": "BJ-HOTEL-02"}},
                {"text": "精品型（青普文化行馆）", "weight": {"hotel": "BJ-HOTEL-03"}}
            ]
        },
        {
            "step": 6,
        ...
        },
        {
            ...
            "question": "是否需要接送服务？",
            "options": [
                {"text": "需要接机（首都机场）", "weight": {"transfer": "BJ-TRANS-04"}},
                {"text": "需要接机（大兴机场）", "weight": {"transfer": "BJ-TRANS-05"}},
                {"text": "需要接站（北京南站）", "weight": {"transfer": "BJ-TRANS-03"}},
